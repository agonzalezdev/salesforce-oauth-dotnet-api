...
RUN dotnet restore "./salesforce-oauth-dotnet-api.csproj"

# Compile, then pack the compiled app and dependencies into a deployable unit.
# https://docs.microsoft.com/en-us/dotnet/core/tools/dotnet-publish?tabs=netcore21
RUN dotnet publish "salesforce-oauth-dotnet-api.csproj" -c Release -o /app/publish
...
ENTRYPOINT ["dotnet", "salesforce-oauth-dotnet-api.dll"]